...
print(f"I want to own a {car_brands[2].title()} someday!") # this is just an example
print(f"{car_brands[1].title()} sucks.") # and this is just an example too
...
work with that item after removing it.The term poop comes from thinking of a list as a stack
